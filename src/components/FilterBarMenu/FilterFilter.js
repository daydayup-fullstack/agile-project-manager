  ...
  return (
    <div className={"ActionList_Filter"}>
      <ul>
        ...
        <li>
          <span class="material-icons filter_person">person_outline</span>
          <span className="filter_tick">
            <h4>Just my tasks</h4>
          </span>
        </li>
        <li>
          <span class="material-icons filter_today">calendar_today</span>
          <span className="filter_tickweek">
            <h4>Due this week</h4>
          </span>
        </li>
        <li className="filter_edge">
          <span class="material-icons filter_next">redo</span>

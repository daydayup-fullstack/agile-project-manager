...
class ProjectDetail extends Component {
  ...
  render() {
    ...
    const { createProject, projectId } = this.props;
...
const mapStateToProps = (state) => {
  ...
  const projectId = projectsReducer.projects[projectsReducer.projects.length - 1]['id'];
  return {
    projectId: projectId
  }
}

export default connect(mapStateToProps, { createProject })(withRouter(ProjectDetail));
